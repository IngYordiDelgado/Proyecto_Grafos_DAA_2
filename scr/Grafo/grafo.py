...
if __name__ == "__main__":
    ...
    prueba.add_nodo("5")
    prueba.add_nodo("7")
    prueba.add_arista("6", "2")
    prueba.add_arista("6", "0")
    prueba.add_arista("2", "0")
    prueba.add_arista("2", "4")
    prueba.add_arista("2", "1")
    prueba.add_arista("0", "1")
    prueba.add_arista("0", "5")
    prueba.add_arista("1", "4")
    prueba.add_arista("1", "5")
    prueba.add_arista("1", "7")
    prueba.add_arista("5", "7")
